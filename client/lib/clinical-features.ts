  ...
  return [
    {
      ...
      description: circleCount ? "Explicit report sharing and roles are available. SOS SMS still needs provider setup." : "Create a circle before sharing records with caregivers.",
    ...
    },
    {
      ...
      description: hasTrendData ? "Trend data is available; ADA/AHA guideline source mapping is not connected yet." : "Upload repeat reports to unlock trend review.",
      status: hasTrendData ? "backend_pending" : "no_data",
      route: "/trends",
    ...
    },
    {
      ...
      description: hasReports ? "Doctor export UI is available with local LOINC hints; backend export endpoint is pending." : "Upload a report to prepare doctor export rows.",
      status: hasReports ? "backend_pending" : "no_data",
    ...
    },
    {
      ...
      title: "WhatsApp Bot -> Conversational Health Logging",
      shortTitle: "WhatsApp Logging",
      description: "Twilio/WhatsApp voice logging is not connected yet. Settings will show setup requirements.",
      status: "backend_pending",
      route: "/settings",
    ...
    },
    {
      ...
      shortTitle: "ICE Card",
      description: "Offline emergency QR is visible. Scan alerts and paramedic notification need backend tracking.",
      status: "backend_pending",
    ...
    {
      id: "wearable_sync",
      title: "Lifestyle Correlation -> Wearable Sync",
      shortTitle: "Wearable Sync",
      description: "Google Fit and Apple Health provider cards are planned; OAuth endpoints are not connected.",
      status: "needs_setup",
      route: "/settings",
      actionLabel: "Connect",
      category: "integration",
    },
    {
      ...
      description: hasAbnormal ? "Diet advice exists; printable seasonal grocery cart backend is pending." : "Needs out-of-range markers for grocery guidance.",
      status: hasAbnormal ? "backend_pending" : "no_data",
    ...
    },
    {
      ...
      description: hasPrescription ? "Prescription timing can be shown locally; refill confirmation endpoint is pending." : "Upload a prescription to track refill risk.",
    ...
    },
    {
      ...
      description: hasTrendData ? "Repeat markers are present; improbable-delta rules need backend support." : "Needs repeat values for the same marker.",
      status: hasTrendData ? "backend_pending" : "no_data",
      route: "/trends",
      actionLabel: "Inspect",
      category: "clinical",
    },
    {
      ...
      description: "Profile-driven screening schedule UI is available; reminders API contract is pending.",
      status: "backend_pending",
      route: "/settings",
      actionLabel: "Review",
      category: "safety",
    ...
    },
    {
      ...
      description: "Hospital discharge upload checklist UI is ready to add; extraction backend is pending.",
      status: "backend_pending",
      actionLabel: "Prepare",
      category: "care",
    },
    {
      ...
      description: hasAbnormal ? "Markers can seed a pathway; coaching backend and habit tracking are pending." : "Needs qualifying markers such as HbA1c, liver, or BP records.",
      status: hasAbnormal ? "backend_pending" : "no_data",
