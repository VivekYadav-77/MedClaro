      ...
      <Card className="space-y-4 p-6">
        ...
        {formOpen ? (
          <form className="grid gap-3 border-t border-slate-100 pt-4 md:grid-cols-2" onSubmit={addMember}>
            ...
            <textarea
              className="min-h-[92px] rounded-lg border border-slate-200 bg-white p-3 text-sm outline-none focus:border-brand-400 md:col-span-2"
        ...
        {members.map((member) => (
          <Card key={member.id} className="space-y-4 p-5">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-[#355166]">Medicine allergies</label>
              <textarea
                className="min-h-[86px] w-full rounded-lg border border-slate-200 bg-white p-3 text-sm outline-none focus:border-brand-400"
              ...
              />
              <Button variant="outline" size="sm" className="gap-2" onClick={() => void saveMemberAllergies(member.id)}>
